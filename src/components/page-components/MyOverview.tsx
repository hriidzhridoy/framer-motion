...
const Block: React.FC<BlockProps> = ({ className, children, ...rest }) => {
  return (
    <motion.div
      variants={{
        initial: {
...
const RevealBento: React.FC = () => {
  return (
    <div className="min-h-screen bg-zinc-900 px-4 py-12 text-zinc-50 w-full">
      <Logo />
      <motion.div
        initial="initial"
        animate="animate"
